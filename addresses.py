...
dwForceAttack = 0x3233024
dwForceAttack2 = 0x3233030
dwForceBackward = 0x3233078
dwForceForward = 0x323306C
dwForceJump = 0x52C0F50
dwForceLeft = 0x3233084
dwForceRight = 0x3233090
dwGameDir = 0x63AE00
dwGameRulesProxy = 0x5334764
dwGetAllClasses = 0xE10F84
dwGlobalVars = 0x59EE60
dwGlowObjectManager = 0x535FCB8
dwInput = 0x52627B0
dwInterfaceLinkList = 0x99F7D4
dwLocalPlayer = 0xDEF97C
dwMouseEnable = 0x523E410
dwMouseEnablePtr = 0x523E3E0
dwPlayerResource = 0x3231380
dwRadarBase = 0x523BCB4
dwSensitivity = 0xD26E002E
dwSensitivityPtr = 0xD26E0002
dwSetClanTag = 0x8DAB0
dwViewMatrix = 0x4DF6024
dwWeaponTable = 0x526388C
dwWeaponTableIndex = 0x326C
dwYawPtr = 0xD26E0002
dwZoomSensitivityRatioPtr = 0xD26E0002
dwbSendPackets = 0xDD2D2
dwppDirect3DDevice9 = 0xA62C0
find_hud_element = 0x2DBF3A40
force_update_spectator_glow = 0x3DD09A
interface_engine_cvar = 0x3FA9C
is_c4_owner = 0x3EA8A0
m_bDormant = 0xED
m_flSpawnTime = 0x103C0
m_pStudioHdr = 0x2950
m_pitchClassPtr = 0x523E308
m_yawClassPtr = 0xD26E0002
model_ambient_min = 0x5A1194
set_abs_angles = 0x1EA950
set_abs_origin = 0x1EA790
